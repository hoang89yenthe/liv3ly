...
11. Double tapping the shape replaces the colour or image based on the above mentioned rules.
11. When a user taps the screen, add an animation for the shapes that appear
12. Remove all shapes when shaking the device
13. Be able to move a shape around
14. Allow a user to use the pinch action to enlarge or shrink the size of a shape
